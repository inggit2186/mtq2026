...
class AdminContentController extends Controller
{
    ...
    public function updateOfficialAccess(Request $request): RedirectResponse
    {
        ...
        $request->validate([
            ...
            'official_can_view_score_detail' => ['nullable', 'boolean'],
        ...
        $setting->fill([
            ...
            'official_can_view_score_detail' => $request->boolean('official_can_view_score_detail'),
        ...
        ActivityLogger::log(
            ...
            [
                ...
                'official_can_view_score_detail' => $setting->official_can_view_score_detail,
