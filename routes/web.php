...
Route::middleware(['auth', 'password.change'])->group(function (): void {
    ...
    Route::post('/admin/finalis/generate/{category}', [FinalistController::class, 'generate'])->middleware('role:admin,panitia')->name('finalists.generate');
    Route::post('/admin/finalis/{finalist}/status', [FinalistController::class, 'updateStatus'])->middleware('role:admin,panitia')->name('finalists.status');
    Route::post('/admin/finalis/category/{category}', [FinalistController::class, 'destroy'])->middleware('role:admin,panitia')->name('finalists.destroy');
    ...
    Route::post('/data-peserta/{participant}/competition-role', [ParticipantRegistrationController::class, 'selectCompetitionRole'])->middleware('role:admin,panitia')->name('participants.competition-role');
    ...
    Route::get('/penilaian/ranking-lot/cetak', [ScoringController::class, 'rankingByLotPdf'])->middleware('role:admin,panitia')->name('scoring.ranking-lot.pdf');
