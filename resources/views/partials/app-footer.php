    ...
    <div class="app-footer-shell overflow-hidden rounded-[2rem] border border-cyan-400/16 bg-gradient-to-br from-slate-900/92 via-sky-950/72 to-blue-950/72 p-6 shadow-[0_20px_60px_-34px_rgba(34,211,238,0.35)]">
        <div class="grid gap-6 xl:grid-cols-[320px_minmax(0,1fr)_320px] xl:items-start">
            ...
            <div class="min-w-0">
                ...
                <h2 class="mt-3 text-2xl font-black tracking-tight text-white sm:text-3xl">e-MTQ Kabupaten Tanah Datar</h2>
                <p class="mt-4 max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
                    ...
                    secara lebih tertata, cepat, dan mudah dipantau oleh semua peran yang terlibat.
                </p>
            ...
            <div class="rounded-[1.5rem] border border-white/10 bg-slate-950/30 px-5 py-4 shadow-[0_18px_45px_-30px_rgba(34,211,238,0.18)]">
                ...
                <a href="https://wa.me/6289509007078" target="_blank" rel="noreferrer" class="mt-2 inline-flex items-center gap-3 text-lg font-black tracking-[0.04em] text-cyan-200 transition hover:text-cyan-100">
