...
if (! function_exists('mtq_icon')) {
    function mtq_icon(string $name, string $classes = 'h-5 w-5'): string
    {
        $icons = [
            ...
            'key' => '<path stroke-linecap="round" stroke-linejoin="round" d="M14.5 10.5a4.5 4.5 0 1 0-1.7 3.5l3.7 3.7h2v2h2v2h2v-2.8l-1.8-1.8h-2l-1.2-1.2"/><circle cx="10" cy="10" r="2"/>',
            ...
            'x' => '<path stroke-linecap="round" stroke-linejoin="round" d="M6 6l12 12"/><path stroke-linecap="round" stroke-linejoin="round" d="M18 6 6 18"/>',
